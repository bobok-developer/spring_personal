            	...
            	<div class="form-group mb-4 col-sm-12 px-0">
	                <select class="custom-select col-md-2" id="inlineFormCustomSelect" name="category" required>
	                    ...
	                    <div class="form-group col-sm-12 col-md-10 float-right pr-0">
						    <input type="text" class="form-control" id="title" placeholder="게시글 제목 입력" name="title" required>
		            ...
		            <div class="form-group">
					    <textarea class="form-control" rows=10 id="content" placeholder="게시글 내용 입력" name="content" required></textarea>
					    <div class="valid-feedback">Valid.</div>
						<div class="invalid-feedback">Please fill out this field.</div>
		   			</div>
					...
					<button type="submit" class="btn waves-effect waves-light btn-rounded btn-primary float-right ml-2">글등록</button>
					<button type="reset" class="btn waves-effect waves-light btn-rounded btn-outline-secondary float-right">다시쓰기</button>
